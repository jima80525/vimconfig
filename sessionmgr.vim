...
"
" See ':help sessionmgr' for more information.
"
...
command! -nargs=? -complete=file SMLog call SessionMgr_Log(<f-args>)
function! SessionMgr_Log(...)
  if a:0 > 0
    execute "redir! >" .  a:1
      silent execute "echo g:SessionMgr_DebugLog"
    redir END
  else
    call confirm("__SessionMgr Log__\n\n" . g:SessionMgr_DebugLog)
  endif
endfunction
...
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" used to auto update the session (if enabled)
